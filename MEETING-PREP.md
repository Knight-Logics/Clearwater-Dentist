...
**Bring:** printed `PRINT-PACK.md` + your phone (backup demo)  
**Use their computer** for live URLs — see PRINT-PACK Page 4  
**Deep reference (phone):** `AUDIT.md` on GitHub or email to yourself  
**Rebuild:** ✅ 72 pages — https://knight-logics.github.io/Clearwater-Dentist/
...
| 30–40 | Systems + **SEO discovery** | GBP, GSC, GA4, Ads — use Phase 3 checklist in AUDIT.md |
...
## Show rebuild preview (on their computer)

Ask to use their front-desk or office PC. Open these in two tabs:

1. **Rebuild:** https://knight-logics.github.io/Clearwater-Dentist/
2. **Live:** https://www.clearwaterdentist.com/

**Your phone as backup:** Same URLs on your phone if they won't share a screen.
